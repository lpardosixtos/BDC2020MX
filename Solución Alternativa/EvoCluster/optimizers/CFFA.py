...
def FFA(objf,lb,ub,dim,n,MaxGeneration, k, points, metric, vols=None, gamma_vol=None, gamma_nodes=None):
    ...
    for Iteration in range (0,MaxGeneration):     # start iterations
        ...
        for i in range(0,n):            
            ...
            if objf.__name__ == 'SSE' or objf.__name__ == 'SC' or objf.__name__ == 'DI':
                ...
                fitnessValue, labelsPredValues=objf(startpts, points, k, vols, gamma_vol, gamma_nodes) 
            else:
