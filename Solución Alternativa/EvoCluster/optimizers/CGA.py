...
def calculateCost(objf, population, dim, popSize, lb, ub, k, points, metric, vols=None):
    ...
    for i in range(0,popSize):
        ...
        elif objf.__name__=='TWCV_vol':
            fitness, labelsPred=objf(startpts, points, k, vols) 
        else:
...
def GA(objf,lb,ub,dim,popSize,iters, k, points, metric, vols=None):
    ...
    for l in range(iters):
        ...
        scores, bestLabelsPred, bestIndividual = calculateCost(objf, ga, dim, popSize, lb, ub, k, points, metric, vols)
